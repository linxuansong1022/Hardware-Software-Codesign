...
OUTPUT_DIR = PROJECT_ROOT / "models" / "gray48_cnn_aug"

IMAGE_SIZE = (48, 48)# 仍然保持 48x48
NUM_CHANNELS = 1 # 灰度图
BATCH_SIZE = 32
EPOCHS = 100
...
def main():
    ...
    # 保存模型
    keras_model_path = OUTPUT_DIR / "gray48_cnn_aug.keras"
    ...
    print(f"已保存训练历史: {history_csv_path}")
